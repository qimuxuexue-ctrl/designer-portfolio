export const ja = {
    ...
    "form.requestType.corporate": "コーポレートサイト",
    "form.requestType.media": "メディアサイト",
    "form.requestType.ecOwn": "ECサイト（自社）",
    "form.requestType.ecMall": "ECサイト（モール型）",
    "form.requestType.recruiting": "採用サイト",
    "form.requestType.campaign": "キャンペーンサイト",
    "form.requestType.webService": "Webサービス",
    "form.requestType.landingPage": "LP制作",
